...
export function createMDCToTiptap(options?: MDCToTiptapOptions) {
  ...
  function mdcToTiptap(body: MDCRoot) {
  ...
  function mdcNodeToTiptap(node: MDCRoot | MDCNode, parent?: MDCNode): JSONContent {
  ...
  function createMark(node: MDCNode, mark: string, accumulatedMarks: { type: string, attrs?: object }[] = []): JSONContent[] {
